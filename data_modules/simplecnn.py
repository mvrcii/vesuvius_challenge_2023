...
def generate_random_balanced_dataset(seed, csv_path, dataset_fraction, frag_ids, ink_threshold, artefact_threshold,
                                     train_split):
    try:
...
class SimpleCNNDataModule(LightningDataModule):
