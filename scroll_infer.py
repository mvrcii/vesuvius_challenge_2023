...
def read_fragment():
    ...
    for i in tqdm(idxs):
        img_path = os.path.join(CFG.data_root_dir, "segments", f"scroll1recto", "slices", f"{i:05}.tif")
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        print("Usage: python infer_scroll.py <checkpoint_path>")
    ...
    results_dir = os.path.join("inference", "results", f"scroll1", date_time_string)
