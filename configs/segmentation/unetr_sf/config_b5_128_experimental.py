...
train_aug = [
    ...
    #     A.MotionBlur(),
    # ], p=0.25),
    A.RandomGamma(always_apply=True, gamma_limit=(90, 130), eps=None),
    A.AdvancedBlur(p=0.05, blur_limit=(3, 5), sigmaX_limit=(0.2, 1.0), sigmaY_limit=(0.2, 1.0),
