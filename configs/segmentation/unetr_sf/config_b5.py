...
train_aug = [
    ...
    A.CoarseDropout(p=0.5, max_holes=5, max_height=patch_size * 0.15,
                    max_width=patch_size * 0.15, min_holes=2, min_height=patch_size * 0.05,
                    min_width=patch_size * 0.05, fill_value=0, mask_fill_value=0),
