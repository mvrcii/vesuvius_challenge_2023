...
train_aug = [
    ...
    A.RandomResizedCrop(p=0.5, height=patch_size, width=patch_size, scale=(0.78, 1.0),
                        ratio=(0.75, 1.51),
                        interpolation=0),
    A.ElasticTransform(always_apply=False, p=0.3, alpha=0.59, sigma=10.34, alpha_affine=9.66, interpolation=0,
                       border_mode=0, value=(0, 0, 0), mask_value=None, approximate=False, same_dxdy=False),
    A.OneOf([
