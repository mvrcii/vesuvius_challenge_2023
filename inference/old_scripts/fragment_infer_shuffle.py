...
if __name__ == '__main__':
    ...
    logit_path = os.path.join(results_dir, f"logits_fragment{fragment_num}__shuffle.png")
    plt.savefig(logit_path, bbox_inches='tight', dpi=500, pad_inches=0)

    # save binary
    plt.imshow(result > 0.5, cmap='gray')
    binary_bath = os.path.join(results_dir, f"binarized_fragment{fragment_num}_shuffle.png")
