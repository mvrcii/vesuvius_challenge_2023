...
def get_transforms(data, cfg):
    if data == 'train':
        return A.Compose(cfg.train_common_aug, is_check_shapes=False), A.Compose(cfg.train_image_aug, is_check_shapes=False)
    elif data == 'val':
...
class WuesuvDataset(Dataset):
    def __init__(self, data_dir, img_dir, label_dir, images, cfg, labels=None, common_aug=None, image_aug=None, train=True):
