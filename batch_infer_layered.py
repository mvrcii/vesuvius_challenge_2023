...
from constants import get_ckpt_name_from_id, get_frag_name_from_id, LIVELY_MEADOW, \
    ...
    IRONHIDE_FRAG_ID, RATCHET_FRAG_ID, JAZZ_FRAG_ID, DEVASTATOR_FRAG_ID, JETFIRE_FRAG_ID, GRIMLOCK_FRAG_ID, \
    HOT_ROD_FRAG_ID, JAZZILLA_FRAG_ID, GRIMLARGE_FRAG_ID
...
FRAGMENT_IDS = [STARSCREAM_FRAG_ID, MEGATRON_FRAG_ID, IRONHIDE_FRAG_ID, RATCHET_FRAG_ID, SOUNDWAVE_FRAG_ID,
                ...
                JAZZILLA_FRAG_ID, GRIMLARGE_FRAG_ID,
